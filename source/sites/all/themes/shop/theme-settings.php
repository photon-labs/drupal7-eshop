...
/**
 * @file
 * Theme setting callbacks for the shop theme.
 */
 ...
 *   The form state.
 */
function shop_form_system_theme_settings_alter(&$form, &$form_state) {

  $form['shop_width'] = array(
    '#type' => 'radios',
    ...
    '#default_value' => theme_get_setting('shop_width'),
